...
import { ExternalLink, Loader2, Image as ImageIcon, Home, ChevronRight } from 'lucide-react'
            ...
            <main className="flex-grow pt-32 pb-24">
                <div className="container max-w-7xl mx-auto px-4">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-16">
                        <div>
                            {/* Breadcrumbs */}
                            <nav className="flex items-center text-sm font-medium text-secondary-500 mb-8 overflow-x-auto whitespace-nowrap">
